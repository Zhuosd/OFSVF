...
def draw_cap_error_picture(ensemble_XZ_imp_CER_fill, X_Zero_CER_fill, ensemble_XZ_imp_CER, X_Zero_CER, Z_impl_CER,
    ...
    # plt.savefig("G:/俺的文档/研二工作/Auto_local_density_peak/Auto_local_density_peak/experiment/OLSMF/magic04/acc.jpg")
    # plt.savefig("E:/俺的文档/研二工作/Auto_local_density_peak/Auto_local_density_peak/experiment/CER/australian/acc.jpg")
    plt.show()
    # plt.clf()
...
def draw_cap_error_picture_tra(ensemble_XZ_imp_CER_fill, X_Zero_CER_fill, ensemble_XZ_imp_CER, X_Zero_CER, Z_impl_CER, Z_impl_CER_fill, dataset):
    ...
    plt.savefig("E:/俺的文档/研二工作/Auto_local_density_peak/Auto_local_density_peak/experiment/auto-OLSMF-tra/steamData/acc.jpg")
    plt.show()
...
def draw_cap_error_picture_1(Z_imp_CER, X_Zero_CER,):
    ...
    plt.savefig("G:/俺的文档/研二工作/Auto_local_density_peak/Auto_local_density_peak/result/australian/acc3.jpg")
    plt.show()
    plt.clf()
...
def draw_tra_error_picture(error_arr_Z, error_arr_X):
    ...
    plt.savefig("G:/俺的文档/研二工作/Auto_local_density_peak/Auto_local_density_peak/result/australian/acc4.jpg")
    plt.show()
    plt.clf()
